    ...
    <SafeAreaView style={styles.container} edges={["left", "right"]}>
      ...
      >
        ...
        <View style={styles.imageSection}>
          <LinearGradient
            colors={[Colors.product.gradientStart, Colors.product.gradientEnd]}
        ...
        <View style={styles.contentSection}>
          ...
          <View style={styles.specificationsSection}>
            ...
            <View style={styles.specificationItem}>
              ...
              <Text style={styles.specificationValue}>{productData.brand}</Text>
            </View>
            <View style={styles.specificationItem}>
      ...
      <View style={styles.bottomSection}>
        <View style={styles.priceContainer}>
          <View style={styles.priceRow}>
            <Text style={styles.currentPrice}>{productData.currentPrice}</Text>
